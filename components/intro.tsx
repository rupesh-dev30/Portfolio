...
import rupesh from "../public/Assets/rupesh.png";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-medium">and have proficiency in numerous </span>
        <span className="font-extrabold italic">programming</span>{" "}
        <span>languages and technology.</span>
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://drive.google.com/file/d/1FPaGpb8dNWKwqoqW29QaRmrcUSrQukEK/view"
          target="_blank"
          download
        >
          Download CV{" "}
